...
public class ThongTinSinhVien extends javax.swing.JFrame {
    ...
    public void loadTable() {
        jTableSinhVien.setModel(new CustomTable(sinhvien.getDssv()));      
    }
    ...
    private void setTextDetail(SinhVien ts){
        ...
        cbMaLop.setSelectedItem(ts.getMaLop());
     ...
     */
     private SinhVien getThiSinhDetail(){
        String  masv=txtMaSinhVien.getText().trim();
        String hoTen=txtHoTen.getText().trim();
        String ngaySinh = txtNgaySinh.getText().trim();
        String gioiTinh;
        if(btngGioiTinh.getSelection().equals(rdbNam.getModel()))
        {
        ...
        return new SinhVien(masv, hoTen, ngaySinh, gioiTinh, diaChi, maLop);
    }
    /**
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(17, 17, 17)
                .addComponent(rdbNam, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(60, 60, 60)
                .addComponent(rdbNu)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rdbNu)
                    .addComponent(rdbNam, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(23, 23, 23))
        );

        cbMaLop.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "M001", "M002", "M003" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cbMaLop, 0, 146, Short.MAX_VALUE)))
        ...
        jTableSinhVien.setEnabled(false);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnThemMoi, javax.swing.GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE)))
        );
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Thông tin khoa và lớp"));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addComponent(cbKhoa, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(110, 110, 110)
                .addComponent(jLabel8)
                .addGap(33, 33, 33)
                .addComponent(cbLopHoc, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnThemMoiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThemMoiMouseClicked
        ...
        try {             
            ...
            SinhVien ts = getThiSinhDetail();
            //thêm 1 bản ghi vào dsTS
            sinhvien.ThemSinhVien(ts);
    ...
    private void btnSuaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSuaMouseClicked
        ...
        try {
            ...
            String  soBD=jTableSinhVien.getValueAt(row, 0).toString();          
            //lấy thí sinh từ giao diện làm thành thí sinh mới
            SinhVien newTS=getThiSinhDetail();
            if(sinhvien.SuaThongTinSV(soBD, newTS))
    ...
    private void btnXoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnXoaMouseClicked
        // TODO add your handling code here:
        try {
            int click=JOptionPane.showConfirmDialog(null,"Chắc chắn xóa sinh viên này","Xoa?",JOptionPane.YES_NO_OPTION);
            if (click==JOptionPane.YES_OPTION) {
    ...
    private void jTableSinhVienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableSinhVienMouseClicked
        ...
        SinhVien ts=sinhvien.getDssv().get(row);
    ...
    private javax.swing.JComboBox cbMaLop;
